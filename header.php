    ...
    style="width:100%;background-color:#A5ABBD;border-bottom-left-radius:10px;border-bottom-right-radius: 10px;box-shadow: 5px 3px 10px black;margin-bottom: 20px;">
      ...
      <div class="collapse navbar-collapse">
       <ul class="navbar-nav">
           ...
           <?php if(isset($_SESSION["id_candidat"]) || isset($_SESSION["id_candidat"])) echo"
           ...
           <?php if(isset($_SESSION["id_candidat"]) || isset($_SESSION["id_candidat"])|| isset($_SESSION["id_admin"])) echo"
           <li class='nav-item active navOptions sign-out'>
           <a href='includes/logout.php' class='nav-link navOptions'><i class='fa-solid fa-power-off'></i></a>
           </li>"?>
